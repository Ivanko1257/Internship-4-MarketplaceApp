...
namespace Data.Entities.Seeds
{
    public static class Seeds
    {
        ...
        public static User user1 = new Buyer("Petar", "Krešimir", "kresimir@gmail.com", 10);
        public static User user2 = new Buyer("Dmitar", "Zvonimir", "zvonimir@gmail.com", 300);
        public static User user3 = new Buyer("Jelena", "Arpadović", "jelenaarp@gmail.com", 250);
        public static User user4 = new Buyer("Stjepan", "Držislav", "drzilav@gmail.com", 30);
        public static User user5 = new Buyer("Petar", "Snačić", "snacic@gmail.com", 40.5);
        public static User user6 = new Seller("Ladislav", "Arpadović", "ladislavarp@gmail.com", new List<Product> { product0,product1, product2 });
        public static User user7 = new Seller("Karlo", "Robert", "robert@gmail.com", new List<Product>{ product3, product4 });
        public static User user8 = new Seller("Pavao", "Šubić-Bribirski", "subicbrib@gmail.com", new List<Product> { product5, product6 });
        public static User user9 = new Seller("Stjepan", "Kotromanić", "kotromanic@gmail.com", new List<Product> { product7, product8, product9 });
